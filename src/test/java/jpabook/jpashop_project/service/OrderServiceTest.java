...
import jpabook.jpashop_project.domain.Address;
import jpabook.jpashop_project.domain.Member;
import jpabook.jpashop_project.domain.Order;
import jpabook.jpashop_project.domain.OrderStatus;
import jpabook.jpashop_project.domain.item.Book;
import jpabook.jpashop_project.domain.item.Item;
import jpabook.jpashop_project.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Assert.assertEquals("주문한 상품의 수가 정확해야한다.", 1, getOrder.getOrderItems().size());
    ...
    public void 상품주문_재고수초과() throws Exception {
        //given
        Member member = createMember();
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "마포", "12345"));
        em.persist(member);
        return member;
    }
